...
GO
-- =============================================
-- Author:		 онстантин Ќагаев
-- Create date: 15.04.2014
-- Description:	«агрузка tls_203 Patstat
-- =============================================
...
inner 
-- loop -- хинт, с ним у мен€ самые быстрые запросы получались (альтернатива hash, merge), можно его включить 
join appln_search ayc
on ayc.appln_id = KEYS.appln_id
group by appln_year
order by count(*) desc;

-- статистика распределени€ документов с требуемыми термами по годам и странам
