...
-- =============================================
CREATE PROCEDURE SP_CREATE_TABLE_TLS_202 
	@lang varchar(2),
...
BEGIN
	...
	SET @SQLString = 'CREATE TABLE [tls202_appln_title_' + @lang + '](
		[appln_id] [int] NOT NULL,
		[appln_title] [varchar](max) COLLATE ' + @collate + ' NOT NULL,
		[tls202_timestamp] [timestamp] NOT NULL,
		CONSTRAINT PK_tls202_appln_title_' + @lang + ' PRIMARY KEY CLUSTERED (appln_id)  
